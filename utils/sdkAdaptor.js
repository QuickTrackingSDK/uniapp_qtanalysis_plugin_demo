...
export default {
	...
	sendEvent: function(eventId, params, eventType = 'CLK', method = 'POST') {
		...
		// #ifdef APP
		const QtAnalytics = uni.requireNativePlugin('qtdev-analytics-plugin')
		/**
		...
		QtAnalytics.onEventObject(eventId, JSON.stringify(params));
		// #endif
	},
	...
	registerGlobalProperties: function(params) {
		...
		QtAnalytics.registerGlobalProperties(value);
		// #endif
	...
	getGlobalProperties: function() {
		// #ifdef APP
		const QtAnalytics = uni.requireNativePlugin('qtdev-analytics-plugin')
		return QtAnalytics.getGlobalProperties();
		// #endif
	...
	unregisterGlobalProperty: function(key) {
		 ...
		 */ 
		QtAnalytics.unregisterGlobalProperty(key);	
	},
	// #endif 
	setUserId: function(puid, organization = 'testOrganization') {
		...
		const QtAnalytics = uni.requireNativePlugin('qtdev-analytics-plugin')
		QtAnalytics.onProfileSignIn(puid, organization)
		// #endif
